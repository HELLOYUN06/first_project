...
<body>
    ...
    <div class="content_area">
        <div class="cate_info">
            ...
            <p> 업데이트 날짜 : <span><fmt:formatDate value="${update.cate}" pattern="yyyy-MM-dd HH:mm:ss"/></span></p>
        </div>
        <div class="post_info">
            ...
            <p> 업데이트 날짜 : <span><fmt:formatDate value="${update.post}" pattern="yyyy-MM-dd HH:mm:ss"/></span></p>
        </div>
        <div class="member_info">
            ...
            <p> 업데이트 날짜 : <span><fmt:formatDate value="${update.member}" pattern="yyyy-MM-dd HH:mm:ss"/></span></p>
        </div>
        <div class="admin_info">
            <h2><i class="fas fa-user-cog"></i>관리자 메뉴</h2>
            <p> 총 관리자 수 : <span>${cnt.admin[0]}</span> </p>
            <p> 업데이트 날짜 : <span><fmt:formatDate value="${update.admin}" pattern="yyyy-MM-dd HH:mm:ss"/></span> </p>
        </div>
    </div>
    </main>
</body>
